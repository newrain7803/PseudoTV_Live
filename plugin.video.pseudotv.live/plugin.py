...
class Plugin:
    def __init__(self, sysARG=sys.argv):
        ...
        try:
            self.myConfig   = self.myService.myConfig
        except:
            from config     import Config
            self.myConfig   = Config(sysARG)
    ...
    def buildMenu(self, name=None):
        ...
        UTIL_MENU = [#(LANGUAGE(30010), '', '', LANGUAGE(30008)),#"Rebuild M3U/XMLTV"
                     ...
                     (LANGUAGE(30160), '', '', LANGUAGE(30008))]#"Parse Kodi Library"
    ...
    def utilities(self, name):
        ...
        elif name == LANGUAGE(30160): self.myConfig.startServiceThread()
        else: return
